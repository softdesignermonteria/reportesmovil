<?php
    ...
    $sql = "select clientes.id,nit,concat_ws(' ', nombre1,nombre2,apellido1, apellido2) as nombres, 
	razon_social, direccion_oficina,direccion_casa,telefono1,celular,departamentos.departamento as departamento, 
	municipios.municipio as municipio from clientes,departamentos, municipios where 
	clientes.departamentos_id=departamentos.id and clientes.municipios_id=municipios.id";
